...
@section('title')
<img src="{!! asset('properties') !!}/images/faq/kiri-pojok.png" class="position-absolute" style="left: -18vh; top:-18vh" >
...
<img src="{!! asset('properties') !!}/images/faq/kanan-pojok.png" class="position-absolute ml-5" style="right: -18vh">
<img src="{!! asset('properties') !!}/images/faq/gambar 1.png" class="position-absolute" style="right: -18vh;">
@endsection
@section('content')
    <style>
        .content {
        ...
        .active:after {
            ...
            <div class="container">
                ...
                <h2 class="mt-5 mb-5 text-warning">Pertanyaan umum : </h2>
            ...
            <div class="container">
                ...
                <h2 class="mt-5 mb-5 position-relative text-warning">Cara pemesanan : </h2>
                <div class="card mt-4 qa">
            ...
            <div class="container">
                ...
                <h2 class="mt-5 mb-5 text-warning">Seputar Haltec : </h2>
                <div class="card mt-4 qa">
                ...
                <h2 class="mt-5 mb-5 text-warning">Tentang produk : </h2>
                <div class="card mt-4 qa">
        ...
        <div class="container">
            <div class="text-center p-5 m-auto" style="width:50%;">
                <h text-warning2>Masih belum menemukan Jawaban</h>
